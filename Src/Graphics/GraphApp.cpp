...
void GraphApp::setPosition(int x, int y)
{
...
void GraphApp::addCourbe(std::string name, sf::Color couleur)
{
...
void GraphApp::addCourbe(std::string name, sf::Color couleur, double(*function)(double), double min, double max, double increment)
{
...
void GraphApp::addPoint(std::string name, sf::Vector2f coord)
{
	m_tempData.push_back(std::make_pair(name, coord));
}

void GraphApp::updateView()
{
	double margin = 30;
	double maxX=-100000;
	double minX=100000;
...
void GraphApp::updateAdd(std::string name, sf::Vector2f coord)
{
	coord.y = -coord.y;
